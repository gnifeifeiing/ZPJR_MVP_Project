...
public class WDTabPageIndicator extends HorizontalScrollView {
    ...
    private int tabTextSize = 12;//标题未被选中的字体大小
    private int tabTextSizeSelected=16;//标题被选中的字体大小
...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public WDTabPageIndicator(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public WDTabPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
    }

    public WDTabPageIndicator(Context context, AttributeSet attrs, int defStyle) {
...
//		canvas.drawRect(lineLeft, 0, lineRight, indicatorHeight, rectPaint);
    ...
    public void setTextSizeSelected(int tabTextSizeSelectedPx) {
        this.tabTextSizeSelected=tabTextSizeSelectedPx;
        updateTabStyles();
    }
