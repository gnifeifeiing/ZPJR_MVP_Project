package com.zpjr.cunguan.ui.activity.security.widget;
...
public class GestureHintView extends View {
    ...
    void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.GesturePreView);

        try {
            normal = typedArray
                    .getDrawable(R.styleable.GesturePreView_normal);
            selected = typedArray
                    .getDrawable(R.styleable.GesturePreView_selected);
    ...
    public GestureHintView(Context context) {
        ...
        normal = context.getResources().getDrawable(
                R.mipmap.ic_gesture_hint);
        selected = context.getResources().getDrawable(
                R.mipmap.ic_gesture_hint_s);
        wPoint = normal.getIntrinsicWidth();
        hPoint = normal.getIntrinsicHeight();
    }
